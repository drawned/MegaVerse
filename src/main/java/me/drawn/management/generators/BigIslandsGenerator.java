...
public class BigIslandsGenerator extends VerseGenerator {
    ...
    public BigIslandsGenerator() {
        super(MegaVerse.getInstance(), "big_islands_generator", "Big Islands Generator", new BukkitBigIslandGenerator(), Material.GRASS_BLOCK);
    }

    public static final class BukkitBigIslandGenerator extends ChunkGenerator {
        ...
        // --- AJUSTES ---
        private final double frequency = 0.0035; // << Frequência MENOR para ilhas MAIORES e mais SUAVES
        ...
        public BukkitBigIslandGenerator() {
